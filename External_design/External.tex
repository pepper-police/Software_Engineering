...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{other/driver.png}
...
\begin{description}[labelwidth=\linewidth]
  ...
  \item [ログアウト機能] 本システgムにログインしている管理者が，ログイン状態を解除できる機能である．
  ログアウトするとログイン画面に遷移する．
...
\begin{description}[labelwidth=\linewidth]
  ...
  \fig{\detokenize{coop_all_do_child}}{一括実行機能}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[height=0.8\textheight]{flow/coop_create_child_acc.pdf}
      \caption{子アカウント発行機能}
      \label{fig:coop_create_child_acc}
    \end{figure}
...
\begin{description}[labelwidth=\linewidth]
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[height=0.9\textheight]{flow/user_deliv_pacement_request.pdf}
    \caption{宅配場所申請機能}
    \label{fig:user_deliv_pacement_request}
  \end{figure}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[height=0.9\textheight]{flow/user_deliv_request.pdf}
    \caption{宅配依頼機能}
    \label{fig:user_deliv_request}
  \end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{other/driver.png}
  \caption{データベース}
  \label{fig:driver}
\end{figure}
\section{ネットワーク設計}
