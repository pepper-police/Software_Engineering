...
\begin{itemize}
    ...
    \item 離島や過疎地域などの従来の方法では配送コストが高かった地域にも，効率的に配送を行うことができる．
...
\begin{itemize}
    ...
    \item 宅配事業者の支援システムは，多くの事業者に提供され，新規事業者の参入を奨励します．
    競争の活発化はサービス品質の向上と価格競争力の向上につながり，消費者にとって選択肢が増えることで市場が活性化します．
...
\begin{center}
    612,736,000円(導入コスト)＋5,706,608,000円(運用コスト)＝6,319,344,000円
\end{center}

\subsection{利益}
本システムを5年間運用した際の利益は以下のようになる．
\begin{center}
    21,600,000,000円(収益)－6,319,344,000(費用)＝15,280,656,000円
\end{center}
