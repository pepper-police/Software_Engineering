...
\section{各モジュール定義}
% 機能を実装するためのコンポーネント
\fig{modules}{module_logout.pdf}{ログインモジュール(バック)}{0.6}
\fig{modules}{module_analysis.pdf}{ログアウトモジュール(バック)}{0.6}
\fig{modules}{module_detail_show.pdf}{一覧表示モジュール}{0.3}
\fig{modules}{module_edit.pdf}{詳細表示モジュール}{0.3}
\fig{modules}{module_list_show.pdf}{登録モジュール}{0.3}
\fig{modules}{module_login.pdf}{編集モジュール}{0.3}
\fig{modules}{module_register.pdf}{分析モジュール}{0.3}
\fig{modules}{module_withdraw.pdf}{退会モジュール}{0.3}
\fig{modules}{def_module_logout.pdf}{ログインモジュール}{0.6}
\fig{modules}{def_module_analysis.pdf}{ログアウトモジュール}{0.6}
\fig{modules}{def_module_detail_show.pdf}{一覧表示モジュール}{0.6}
\fig{modules}{def_module_edit.pdf}{詳細表示モジュール}{0.6}
\fig{modules}{def_module_list_show.pdf}{登録モジュール}{0.6}
\fig{modules}{def_module_login.pdf}{編集モジュール}{0.6}
\fig{modules}{def_module_register.pdf}{分析モジュール}{0.6}
\fig{modules}{def_module_withdraw.pdf}{退会モジュール}{0.6}
...
\fig{components}{blade_button_create.pdf}{ボタン生成(フロント)}{0.3}
\fig{components}{blade_data_detail.pdf}{データの詳細表示(フロント)}{0.3}
\fig{components}{blade_data_input_form.pdf}{データの入力フォーム(フロント)}{0.3}
\fig{components}{blade_data_list.pdf}{データの一覧表示(フロント)}{0.3}
\fig{components}{blade_data_send.pdf}{データ送信(フロント)}{0.3}
\fig{components}{ctrl_data_receive.pdf}{データの受け取り(バック)}{0.3}
\fig{components}{ctrl_data_send.pdf}{データ送信(バック)}{0.3}
\fig{components}{ctrl_database_query.pdf}{データベース問い合わせ(バック)}{0.3}
\fig{components}{ctrl_database_register.pdf}{データベース新規登録(バック)}{0.3}
\fig{components}{ctrl_database_update.pdf}{データベース更新(バック)}{0.3}
\fig{components}{ctrl_page_transition.pdf}{ページ遷移(バック)}{0.3}
\fig{components}{ctrl_validation.pdf}{バリデーション(バック)}{0.3}
\fig{components}{def_blade_button_create.pdf}{ボタン生成(フロント)}{0.6}
\fig{components}{def_blade_data_detail.pdf}{データの詳細表示(フロント)}{0.6}
\fig{components}{def_blade_data_input_form.pdf}{データの入力フォーム(フロント)}{0.6}
\fig{components}{def_blade_data_list.pdf}{データの一覧表示(フロント)}{0.6}
\fig{components}{def_blade_data_send.pdf}{データ送信(フロント)}{0.6}
\fig{components}{def_ctrl_data_receive.pdf}{データの受け取り(バック)}{0.6}
\fig{components}{def_ctrl_data_send.pdf}{データ送信(バック)}{0.6}
\fig{components}{def_ctrl_database_query.pdf}{データベース問い合わせ(バック)}{0.6}
\fig{components}{def_ctrl_database_register.pdf}{データベース新規登録(バック)}{0.6}
\fig{components}{def_ctrl_database_update.pdf}{データベース更新(バック)}{0.6}
\fig{components}{def_ctrl_page_transition.pdf}{ページ遷移(バック)}{0.6}
\fig{components}{def_ctrl_validation.pdf}{バリデーション(バック)}{0.6}
